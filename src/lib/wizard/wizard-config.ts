...
const contextModule: WizardModule = {
  ...
  questions: [
    ...
    },
    {
      id: "problems",
      type: "checkbox",
      label: "Quels problèmes rencontrez-vous ? (plusieurs choix possibles)",
      required: true,
      minSelect: 1,
      allowOther: true,
      options: [
        { value: "performance", label: "Problèmes de performance / lenteurs" },
        { value: "reliability", label: "Pannes fréquentes / manque de fiabilité" },
        { value: "compatibility", label: "Problèmes de compatibilité" },
        { value: "capacity", label: "Capacité insuffisante" },
        { value: "obsolescence", label: "Équipement obsolète / fin de support" },
        { value: "security", label: "Risques de sécurité" },
        { value: "missing_feature", label: "Fonctionnalité manquante" },
        { value: "cost", label: "Coûts de maintenance élevés" },
